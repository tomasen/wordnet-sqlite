...
{ // tenses
    let sql = `SELECT DISTINCT word, phrase FROM word, sense WHERE word.id = sense.wordid AND sense.sstype = "v"`;
...
{ // plural
    let sql = `SELECT DISTINCT word FROM word, sense WHERE word.id = sense.wordid AND sense.sstype = "n"`;
